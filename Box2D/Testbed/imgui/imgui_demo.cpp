...
void ImGui::ShowTestWindow(bool* p_opened)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("UTF-8 Text"))
        {
            ...
            // However for the sake for maximum portability here we are *not* including raw UTF-8 character in this source file, instead we encode the string with hexadecimal Log.
